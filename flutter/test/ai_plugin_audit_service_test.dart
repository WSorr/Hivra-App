    ...
    test('audits installed plugin package digest deterministically', () async {
      ...
      final service = AiPluginAuditService(
        registry: _FakeRegistry(
          dir: tempDir,
          records: <WasmPluginRecord>[_record(storedFileName: 'plugin.zip')],
        ),
      );
      ...
      expect(
        first.entries.single.packageDigestHex,
...
class _FakeRegistry extends WasmPluginRegistryService {
  ...
  const _FakeRegistry({required this.dir, required this.records});
