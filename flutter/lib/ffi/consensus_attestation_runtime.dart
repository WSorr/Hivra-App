...
Map<String, Object?> sendConsensusAttestationInWorker(
  ...
  final result = hivra.sendPairConsensusAttestationCode(toPubkey, payloadJson);
  return <String, Object?>{
    'result': result,
...
Map<String, Object?> receiveConsensusAttestationsInWorker(
  ...
  final result = hivra.receivePairConsensusAttestationsJson();
  return <String, Object?>{
    'result': result.code,
    'json': result.json,
    'lastError': hivra.lastErrorMessage(),
