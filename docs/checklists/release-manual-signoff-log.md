...
| v1.0.3-test15 | 2026-08-01T20:49:41Z | macOS | hivra_app-v1.0.3-test15-macos-universal.zip | PASS | PASS | PASS | PASS | PASS | codex + user | Exact ZIP SHA-256 2759033415f6f67da9a6bbc653263a6a060eeb993055e770e9b0ffe9fcc8ad55 launched from a fresh temporary extraction. Canonical h1 selector identities and 5/5/5 starter summaries were verified; Trading Drone loaded 944 perp symbols, completed the intent analysis path, and restored exchange orders without creating a new financial effect. Moltbook 0.7.0 account, draft, approval, publication, and bounded-cycle paths were exercised in this release session. Unsigned/not notarized test build. |
