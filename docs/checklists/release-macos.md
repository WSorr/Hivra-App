...
```bash
tools/release/check_manual_release_signoff.sh --build-tag <version-tag> --platform macOS --channel <test|public>
```
...
- [ ] Manual macOS signoff was validated with `tools/release/check_manual_release_signoff.sh --build-tag <version-tag> --platform macOS --channel <test|public>`.
