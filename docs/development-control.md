...
| What is the next 1.x step? | Complete Pass U remediation without a second authority, journal owner, or provider path. | This board; detailed history remains in `roadmap.md` |
