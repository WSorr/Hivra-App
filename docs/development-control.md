...
| **Future product tracks** | Parked except for Moltbook draft prototype | AI trading advice, distributed backup drone, staking drone, and future Moltbook remote effects. The Moltbook draft-only WASM contract is implemented but not catalogued. | Their own approved contract and capability-closure result. | They do not preempt active 1.x integrity work. |
