...
| What is the next 1.x step? | Complete Pass T without exposing the prepared credential to the runner process. | This board; detailed history remains in `roadmap.md` |
