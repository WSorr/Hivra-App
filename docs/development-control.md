...
automatic publication authority was added. No active release-blocking 1.x
...
| What is the next 1.x step? | None selected after Moltbook Reference-Grade Pass B. Review the remaining evidence-backed debt before choosing another bounded product or release pass. | `docs/roadmap.md`, existing release and lifetime checklists |
...
| --- | --- | --- | --- | --- |
| **1.x maintained runtime** | No active release-blocking finding | Existing 1.x runtime remains the sole production line. Moltbook Reference-Grade passes A-B are complete. | `v1.0.3-test16` cross-platform signoff, session stop/re-enable regressions, and Android Assisted post/reply evidence completed without a new effect path. | Select another implementation unit only for a reproduced finding or explicit product decision. |
...
1. **P1 — next 1.x unit:** none selected after Moltbook Reference-Grade Pass B.
