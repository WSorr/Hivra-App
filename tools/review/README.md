...
- `projection_discipline_gate.sh` validates that key projection readers use shared `LedgerViewSupport.kindLabel` mapping rather than local event-kind dictionaries.
