...
require_present "$DEVELOPMENT_CONTROL" '`V2-1 / pass A`, design-only Capsule identity' \
  "development control selects V2-1 contract design without opening a runtime path"
