...
/// Project a ledger JSON document into the canonical relationship current view.
#[no_mangle]
pub unsafe extern "C" fn hivra_project_relationship_current_view_v1(
    ledger_json: *const c_char,
    ...
    let view = hivra_core::relationship_current_view_v1(&ledger, local_transport);
    let json = match serde_json::to_string(&view) {
        Ok(value) => value,
        Err(_) => return -4,
    };
